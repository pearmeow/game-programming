...
public:
    ...
    Entity();
    ;
    Entity(Vector2 position, Vector2 scale, std::vector<const char*> textureFilepaths, TextureType textureType,
    ...
    std::map<WitchState, Texture2D> getTextures() const {
        return mTextures;
    }
    ...
    std::map<WitchState, std::vector<int>> getAnimationAtlas() const {
