...
void Entity::displayCollider() {
    ...
    Rectangle colliderBox = {mPosition.x - mColliderDimensions.x / 2.0f,
                             mPosition.y - mColliderDimensions.y / 2.0f, mColliderDimensions.x,
...
void Entity::update(float deltaTime, Entity* collidableEntities, int collisionCheckCount, Entity* moreEntities,
                    int moreEntitiesCount) {
    ...
    checkCollisionY(moreEntities, moreEntitiesCount);

    mPosition.x += mVelocity.x * deltaTime;
    checkCollisionX(collidableEntities, collisionCheckCount);
    checkCollisionX(moreEntities, moreEntitiesCount);
    ...
    switch (mTextureType) {
        case SINGLE:
            ...
            textureArea = {// top-left corner
                           ...
                           static_cast<float>(mTexture.width), static_cast<float>(mTexture.height)};
            break;
        case ATLAS:
            textureArea = getUVRectangle(&mTexture, mAnimationIndices[mCurrentFrameIndex],
