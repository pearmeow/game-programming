...
// Global Constants
constexpr int SCREEN_WIDTH = 800 * 1.5f, SCREEN_HEIGHT = 450 * 1.5f, FPS = 60, SIDES = 3;
...
float gScaleFactor = BASE_SIZE, gAngle = 0.0f, gPulseTime = 0.0f;
...
void update() {
    ...
    gScaleFactor = MAX_AMPLITUDE * std::sin(gPulseTime) + BASE_SIZE;
}
...
void render() {
    ...
    DrawPoly(gPosition, SIDES, gScaleFactor, gAngle, ColorFromHex("#F88379"));
